...
public enum ConfigSingleton {
	...
	public int waterPercentage = 20; // how large of a percentage of the map is approximately covered with waterTiles.
	...
	/**
	 * These variables are only relevant if the needDrinking boolean is set to true, as 
	 * they determine determine the way in which creatures interact with water:
	 */
	...
	public void finalizeVariables() {
		...
		if (mapGenSeed == 0) {
			...
			mainSeedRNG.nextLong(); // makes sure that the second number this RNG generates is used for the mapGenSeed
