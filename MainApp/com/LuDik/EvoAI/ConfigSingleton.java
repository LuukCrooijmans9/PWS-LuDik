...
public enum ConfigSingleton {
	...
	// Map generation
		public double mapSmoothness = 0.1; // hoe hoger hoe ruwer de overgang van fertility/water, eigenlijk hoe
														// ver je ingezoomt zit op de perlin noise.
		public long mainSeed = 0; // Seed is een double van 0 tot 255. negatief laten voor random seed
		public long mapGenSeed = 0; // Seed is een double van 0 tot 255. negatief laten voor random seed

		public int tileSize = 40;
		public int mapSizeInTiles = 100;

		public double evolutionFactor = 0.002; // 1 is maximale evolution 0 is geen evolutie
		
		public int beginAmountCreatures = 400;
		public int ratioChildsPerParent = 2; // 2 wil zeggen dat elke parent 2 childs krijgt
		public int randomCreaturesPerGeneration = 5; // hoeveel volledig nieuwe creatures er bij komen
																			// per generatie
