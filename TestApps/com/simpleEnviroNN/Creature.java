...
//	private Shape crtrShape;
	...
	private static boolean disableTurningSpeed = false;
	  ...
	  Creature(double x, double y, Board brd) {
		initCreature(x, y);
...
//		System.out.println("Creature instantiated!");
	...
	private void initCreature(double x, double y) {
	  ...
	  Line2D.Double[] getCreatureDirectionTriangle() {
	...
	private void attractToCenter() {
	  ...
	  void notifyTimePassed(long timePassed) {
	  ...
	  static double getCrtrSize() {
		return crtrSize;
	}
	
	  static void setDisableTurningSpeed(boolean state) {
		disableTurningSpeed = state;	
	}
	
	  static void setAttractToCenter(boolean state) {
		attractToCenter = state;	
	}
	
	  static boolean getDisableTurningSpeed() {
		return disableTurningSpeed;	
	}
	
	  static boolean getAttractToCenter() {
		return attractToCenter;	
	}
	
	  static double getCenterPull() {
		return centerPull;
	} 
	
	  static void setCenterPull(double newValue) {
		centerPull = newValue;
	}
	
	  static double getRandomFactorTurn() {
		return randomFactorTurn;
	} 
	
	  static void setRandomFactorTurn(double newValue) {
		randomFactorTurn = newValue;
	}
	
	  static double getRandomFactorAcc() {
		return randomFactorAcc;
	} 
	
	  static void setRandomFactorAcc(double newValue) {
	  ...
	  static void setCrtrSize(int crtrSize) {
